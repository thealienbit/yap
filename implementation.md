Perfect. Before writing any code, this is **exactly** what you should do.

Below is a **clean, implementation-ordered breakdown** of *everything we’ve designed*, split into **logical build segments**, with **clear dependencies**.
You can treat this as your **engineering roadmap**.
...
**Why first:** everything depends on clean structure.
...
> No vault logic yet. Crypto must stand alone and be testable.
